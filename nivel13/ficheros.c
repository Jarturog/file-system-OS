...
int mi_write_f(unsigned int ninodo, const void *buf_original, unsigned int offset, unsigned int nbytes) {
    ...
    unsigned int bloquesOcupadosPorInodo;
    struct inodo inodo;
    ...
    bloquesOcupadosPorInodo = inodo.numBloquesOcupados;
    mi_waitSem();
    ...
    if (inodo.numBloquesOcupados != bloquesOcupadosPorInodo) { // si se han ocupado bloques
        bloquesOcupadosPorInodo = inodo.numBloquesOcupados;
